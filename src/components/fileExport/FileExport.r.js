...
class FileExport extends Component{
    ...
    render(){
        const {setButtonStyle,title,disabled,WrapComponent} = this.props;
        return(
            <WrapComponent style={{...setButtonStyle}} disabled={disabled} onClick={this.handleDownload.bind(this)}>
